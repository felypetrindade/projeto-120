...
def preprocess_user_input(user_input):
    ...
    input_tokenizer = nltk.word_tokenize(user_input)

    # converta a entrada do usuário em sua palavra-raiz: stemização
    input_tokenizer_2 = get_stem_words(input_tokenizer, ignore_words)

    # Remova duplicidades e classifique a entrada do usuário
    input_tokenizer_2 = sorted(list(set(input_tokenizer_2)))
   
    # Codificação de dados de entrada: crie a BOW para  user_input
    for word in words:
        if word in input_tokenizer_2:
